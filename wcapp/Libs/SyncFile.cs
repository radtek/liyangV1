...
namespace WCAPP.Libs
{
    public class SyncFile
    {
        ...
        public SyncFile(Stream inputStream)
        {
            try
            {
        ...
        public SyncFile(SynchroTable[] sync)
        {
            JavaScriptSerializer serializer = new JavaScriptSerializer();
            //serializer.RecursionLimit = 1;
            json = serializer.Serialize(sync);
        }
        ...
        public SynchroTable[] ToSync()
        {
            return new JavaScriptSerializer().Deserialize<SynchroTable[]>(json);
        }        
    }
}